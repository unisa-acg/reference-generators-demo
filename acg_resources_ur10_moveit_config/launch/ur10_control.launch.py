...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "controllers_file",
            default_value="ur10_ft_controllers.yaml",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="acg_resources_ur10_description",
            description="The package containing the calibration configuration of the actual UR10 used.",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
            "kinematics_params_file",
            default_value="ur10_kinematics.yaml",
            description="The calibration configuration of the actual UR10 used.",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
