...
private:
   ...
   */
  acg_control_msgs::msg::TaskSpacePoint apply_reference_scaling_();

  /**
   * @brief Parameter handler to handle the controller parameters.
   */
  std::shared_ptr<acg_admittance_controller::ParamListener> admittance_controller_param_handler_;
   ...
   */
  std::shared_ptr<acg_diagnostics::PeriodicPublisher<acg_control_msgs::msg::AdmittanceControllerState>> state_publisher_;
};
