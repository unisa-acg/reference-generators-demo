...
void ConfiguredEffortSensorTest::SetUp()
{
  ...
  exp_size_ = 6;
  effort_sensor_ = std::make_unique<xxx_semantic_components::EffortSensor>(sensor_name_, exp_size_);
...
TEST_F(EffortSensorTest, test_wrong_size_constructor)
{
  ...
  EXPECT_THROW(std::make_unique<xxx_semantic_components::EffortSensor>(sensor_name_, 3, std::vector<std::string>{ "wrong_size" }),
...
TEST_F(EffortSensorTest, test_custom_interface_names)
{
  ...
  effort_sensor_ = std::make_unique<xxx_semantic_components::EffortSensor>(sensor_name_, custom_interface_names.size(), custom_interface_names);
