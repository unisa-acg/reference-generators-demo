...
protected:
  ...
  std::unique_ptr<xxx_semantic_components::WrenchDerivativeCommand> wrench_derivative_command_;
};
...
{
  EXPECT_THROW(xxx_semantic_components::WrenchDerivativeCommand(device_name_, std::vector<std::string>{ "wrong_size" }), std::invalid_argument);
}
...
TEST_F(WrenchDerivativeCommandTest, test_custom_interface_names)
{
  ...
  wrench_derivative_command_ = std::make_unique<xxx_semantic_components::WrenchDerivativeCommand>(device_name_, custom_interface_names);
...
TEST_F(WrenchDerivativeCommandTest, test_default_interface_names)
{
  ...
  wrench_derivative_command_ = std::make_unique<xxx_semantic_components::WrenchDerivativeCommand>(device_name_);
