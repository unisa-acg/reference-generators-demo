...
protected:
  ...
  std::unique_ptr<xxx_semantic_components::TwistCommand> twist_command_;
};
...
void ConfiguredTwistCommandTest::SetUp()
{
  ...
  exp_size_ = 6;
  twist_command_ = std::make_unique<xxx_semantic_components::TwistCommand>(device_name_);
...
TEST_F(TwistCommandTest, test_wrong_size_interface_names)
{
  ...
  EXPECT_THROW(std::make_unique<xxx_semantic_components::TwistCommand>(device_name_, std::vector<std::string>{ "wrong_size" }),
...
TEST_F(TwistCommandTest, test_custom_interface_names)
{
  ...
  twist_command_ = std::make_unique<xxx_semantic_components::TwistCommand>(device_name_, custom_interface_names);
