...
void ConfiguredPositionEncoderTest::SetUp()
{
  ...
  exp_size_ = 7;
  position_encoder_ = std::make_unique<xxx_semantic_components::PositionEncoder>(sensor_name_, exp_size_);
...
TEST_F(PositionEncoderTest, test_wrong_size_constructor)
{
  ...
  EXPECT_THROW(std::make_unique<xxx_semantic_components::PositionEncoder>(sensor_name_, 3, std::vector<std::string>{ "wrong_size" }),
...
TEST_F(PositionEncoderTest, test_custom_interface_names)
{
  ...
  position_encoder_ = std::make_unique<xxx_semantic_components::PositionEncoder>(sensor_name_, custom_interface_names.size(), custom_interface_names);
