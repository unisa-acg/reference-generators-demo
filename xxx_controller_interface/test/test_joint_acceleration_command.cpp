...
void ConfiguredJointAccelerationCommandTest::SetUp()
{
  ...
  joint_acceleration_command_ = std::make_unique<xxx_semantic_components::JointAccelerationCommand>(device_name_, exp_size_);
...
TEST_F(JointAccelerationCommandTest, test_wrong_size_constructor)
{
  ...
  EXPECT_THROW(xxx_semantic_components::JointAccelerationCommand(device_name_, 3, std::vector<std::string>{ "wrong_size" }), std::invalid_argument);
}
...
TEST_F(JointAccelerationCommandTest, test_custom_interface_names)
{
  ...
  joint_acceleration_command_ =
      std::make_unique<xxx_semantic_components::JointAccelerationCommand>(device_name_, custom_interface_names.size(), custom_interface_names);
