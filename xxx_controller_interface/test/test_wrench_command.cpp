...
protected:
  ...
  std::unique_ptr<xxx_semantic_components::WrenchCommand> wrench_command_;
};
...
void ConfiguredWrenchCommandTest::SetUp()
{
  ...
  exp_size_ = 6;
  wrench_command_ = std::make_unique<xxx_semantic_components::WrenchCommand>(device_name_);
...
TEST_F(WrenchCommandTest, test_wrong_size_interface_names)
{
  ...
  EXPECT_THROW(std::make_unique<xxx_semantic_components::WrenchCommand>(device_name_, std::vector<std::string>{ "wrong_size" }),
...
TEST_F(WrenchCommandTest, test_custom_interface_names)
{
  ...
  wrench_command_ = std::make_unique<xxx_semantic_components::WrenchCommand>(device_name_, custom_interface_names);
