...
void ConfiguredJointVelocityCommandTest::SetUp()
{
  ...
  exp_size_ = 7;
  joint_velocity_command_ = std::make_unique<xxx_semantic_components::JointVelocityCommand>(device_name_, exp_size_);
...
TEST_F(JointVelocityCommandTest, test_wrong_size_constructor)
{
  ...
  EXPECT_THROW(xxx_semantic_components::JointVelocityCommand(device_name_, 3, std::vector<std::string>{ "wrong_size" }), std::invalid_argument);
}
...
TEST_F(JointVelocityCommandTest, test_custom_interface_names)
{
  ...
  joint_velocity_command_ =
      std::make_unique<xxx_semantic_components::JointVelocityCommand>(device_name_, custom_interface_names.size(), custom_interface_names);
