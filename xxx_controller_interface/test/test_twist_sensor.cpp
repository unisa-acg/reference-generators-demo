...
// Class under test
#include "xxx_semantic_components/twist_sensor.hpp"
...
protected:
  ...
  std::unique_ptr<xxx_semantic_components::TwistSensor> twist_sensor_;
};
...
void ConfiguredTwistSensorTest::SetUp()
{
  ...
  twist_sensor_ = std::make_unique<xxx_semantic_components::TwistSensor>(sensor_name_);
...
TEST_F(TwistSensorTest, test_twist_sensor_wrong_size_interface_names)
{
  ...
  EXPECT_THROW({ twist_sensor_ = std::make_unique<xxx_semantic_components::TwistSensor>(sensor_name_, custom_interface_names); },
...
TEST_F(TwistSensorTest, test_twist_sensor_custom_interface_names)
{
  ...
  twist_sensor_ = std::make_unique<xxx_semantic_components::TwistSensor>(sensor_name_, custom_interface_names);
