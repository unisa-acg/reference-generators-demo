...
To test the controller in simulation, please refer to the documentation of [`ur10_gravity_compensation_pd_controller_demo`](../ur10_gravity_compensation_pd_controller_demo/README.md#simulation-with-gravity-compensation-PD-controller).
