...
## reference_interfaces_names_override.joint_position

If this parameter is set, it will override the default names for the joint position interface of the reference interfaces.
