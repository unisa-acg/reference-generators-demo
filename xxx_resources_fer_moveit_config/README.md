# xxx_resources_fer_moveit_config
...
```bash
ros2 launch xxx_resources_fer_moveit_config demo.launch.py
```
...
```bash
ros2 launch xxx_resources_fer_moveit_config demo.launch.py rviz_config:=planning_demo.rviz
```
...
```bash
ros2 launch xxx_resources_fer_moveit_config ros2_control_demo.launch.py
```
...
```bash
ros2 launch xxx_resources_fer_moveit_config gazebo_ros2_control_demo.launch.py
```
...
```bash
ros2 launch xxx_resources_fer_moveit_config moveit_gazebo_ros2_control_demo.launch.py
```
