...
{
  std::shared_ptr<rclcpp_action::ServerGoalHandle<xxx_control_msgs::action::FollowTaskSpaceTrajectory>> goal_handle_{ nullptr };
};
...
protected:
  ...
  rclcpp_action::GoalResponse handle_goal_(const rclcpp_action::GoalUUID& uuid,
                                           std::shared_ptr<const xxx_control_msgs::action::FollowTaskSpaceTrajectory::Goal> goal);
  ...
  handle_cancel_(const std::shared_ptr<rclcpp_action::ServerGoalHandle<xxx_control_msgs::action::FollowTaskSpaceTrajectory>> goal_handle);
   ...
   * Refer to the documentation of the action server for more details about the parameters.
   */
  void handle_accepted_(const std::shared_ptr<rclcpp_action::ServerGoalHandle<xxx_control_msgs::action::FollowTaskSpaceTrajectory>> goal_handle);
   ...
   */
  void task_space_reference_callback_(const std::shared_ptr<xxx_control_msgs::msg::TaskSpacePoint> msg);
   ...
   */
  static xxx_control_msgs::msg::TaskSpacePoint
  compute_task_space_error_(const std::shared_ptr<xxx_control_msgs::action::FollowTaskSpaceTrajectory::Feedback>& feedback);
  ...
  rclcpp::Subscription<xxx_control_msgs::msg::TaskSpacePoint>::SharedPtr task_space_reference_subscriber_;
  ...
  rclcpp_action::Server<xxx_control_msgs::action::FollowTaskSpaceTrajectory>::SharedPtr task_space_trajectory_action_server_;
  ...
  xxx_control_msgs::msg::TaskSpacePoint robot_actual_task_space_state_;
  ...
  typedef xxx_control_msgs::action::FollowTaskSpaceTrajectory::Feedback TaskSpaceTrajFeedback;
  ...
  xxx_control_msgs::msg::TaskSpaceTrajectoryPoint current_traj_point_;
  xxx_control_msgs::msg::TaskSpaceTrajectoryPoint next_traj_point_;
