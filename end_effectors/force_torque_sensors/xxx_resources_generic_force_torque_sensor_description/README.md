# xxx_resources_generic_force_torque_sensor_description
...
```bash
ros2 launch xxx_resources_generic_force_torque_sensor_description display.launch.py height:=0.05 radius:=0.1
```
