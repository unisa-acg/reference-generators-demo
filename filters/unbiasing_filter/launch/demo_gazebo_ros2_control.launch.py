...
def launch_setup(context, *args, **kwargs):
    gazebo_ros2_control_demo_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            "safety_limits": "true",
            "runtime_config_package": "unbiasing_filter",
            "controllers_file": "test/config/unbiasing_filter_test_controllers.yaml",
            "tf_prefix": "",
            "launch_rviz": "false",
            "enable_ft_sensing": "true",
            "enable_effort_interfaces": "false",
            "ft_plot": "false",
            "ee_config_package": "unbiasing_filter",
            "ee_config_file": "test/config/unbiasing_filter_test_ee_config.yaml",
        }.items(),
    )
