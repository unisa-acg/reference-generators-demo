...
TEST(MessageUtilitiesTest, TestClearWrench)
{
  ...
  // Clear the wrench
  xxx_message_utilities::clear(wrench);
...
TEST(MessageUtilitiesTest, TestClearTaskSpacePoint)
{
  ...
  xxx_message_utilities::clear(task_space_point);
...
TEST(MessageUtilitiesTest, TestClearJointSpacePoint)
{
  ...
  xxx_control_msgs::msg::JointWrenchPoint joint_space_point;
  ...
  xxx_message_utilities::clear(joint_space_point);
...
TEST(MessageUtilitiesTest, TestIsNanWhenPoseIsNotNan)
{
  ...
  EXPECT_FALSE(xxx_message_utilities::is_nan(pose));
}
...
TEST(MessageUtilitiesTest, TestIsNanWhenPoseIsNan)
{
  ...
  // Check if the pose is NaN
  EXPECT_TRUE(xxx_message_utilities::is_nan(pose));
}
...
TEST(MessageUtilitiesTest, TestIsNanWhenTwistIsNotNan)
{
  ...
  EXPECT_FALSE(xxx_message_utilities::is_nan(twist));
}
...
TEST(MessageUtilitiesTest, TestIsNanWhenTwistIsNan)
{
  ...
  // Check if the twist is NaN
  EXPECT_TRUE(xxx_message_utilities::is_nan(twist));
}
...
TEST(MessageUtilitiesTest, TestIsNanWhenWrenchIsNotNan)
{
  ...
  EXPECT_FALSE(xxx_message_utilities::is_nan(wrench));
}
...
TEST(MessageUtilitiesTest, TestIsNanWhenWrenchIsNan)
{
  ...
  // Check if the wrench is NaN
  EXPECT_TRUE(xxx_message_utilities::is_nan(wrench));
}
...
TEST(MessageUtilitiesTest, TestIsValidWhenTwistIsValid)
{
  ...
  EXPECT_TRUE(xxx_message_utilities::is_valid(twist));
}
...
TEST(MessageUtilitiesTest, TestIsValidWhenTwistIsNotValid)
{
  ...
  // Check if the twist is valid
  EXPECT_FALSE(xxx_message_utilities::is_valid(twist));
}
