...
#include <xxx_control_msgs/msg/joint_trajectory_point.hpp>
...
{
  xxx_interpolation::linearly_interpolate(first_point, second_point, t_normalized, interpolated_point);
...
TEST(VectorDoubleInterpolationExceptionTest, ThrowsOnDifferentInputSizes)
{
  ...
  EXPECT_THROW(xxx_interpolation::linearly_interpolate(a, b, 0.5, out), std::runtime_error);
}
...
{
  xxx_control_msgs::msg::JointTrajectoryPoint first_point;
  xxx_control_msgs::msg::JointTrajectoryPoint second_point;
  double t;
  xxx_control_msgs::msg::JointWrenchPoint expected_point;
};
...
protected:
  ...
  double t;
  xxx_control_msgs::msg::JointWrenchPoint expected_point;
  xxx_control_msgs::msg::JointWrenchPoint interpolated_point;
};
...
TEST_P(JointPointInterpolationTestSuite, SampleJointPoint)
{
  ...
  xxx_interpolation::linearly_interpolate(first_point, second_point, t, interpolated_point);
...
{
  xxx_control_msgs::msg::JointTrajectoryPoint first, second;
  first.time_from_start = rclcpp::Duration::from_seconds(2.0);
  second.time_from_start = rclcpp::Duration::from_seconds(1.0);
  xxx_control_msgs::msg::JointWrenchPoint out;
  EXPECT_THROW(xxx_interpolation::linearly_interpolate(first, second, 1.5, out), std::runtime_error);
}
...
TEST(JointPointInterpolationExceptionTest, ThrowsOnTimeOutOfBounds)
{
  ...
  xxx_control_msgs::msg::JointWrenchPoint out;
  // t < first_timestamp
  EXPECT_THROW(xxx_interpolation::linearly_interpolate(first, second, -0.1, out), std::runtime_error);
  // t > second_timestamp
  EXPECT_THROW(xxx_interpolation::linearly_interpolate(first, second, 2.0, out), std::runtime_error);
}
...
{
  xxx_control_msgs::msg::TaskSpaceTrajectoryPoint first_point;
  xxx_control_msgs::msg::TaskSpaceTrajectoryPoint second_point;
  double t;
...
protected:
  ...
  double t;
  xxx_control_msgs::msg::TaskSpacePoint expected_point;
  xxx_control_msgs::msg::TaskSpacePoint interpolated_point;
};
...
{
  xxx_control_msgs::msg::TaskSpaceTrajectoryPoint first, second;
  first.time_from_start = rclcpp::Duration::from_seconds(2.0);
  second.time_from_start = rclcpp::Duration::from_seconds(1.0);
  xxx_control_msgs::msg::TaskSpacePoint out;
  EXPECT_THROW(xxx_interpolation::linearly_interpolate(first, second, 1.5, out), std::runtime_error);
}
