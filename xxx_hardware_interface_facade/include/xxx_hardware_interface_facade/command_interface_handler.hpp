...
#include <xxx_semantic_components/joint_velocity_command.hpp>
#include <xxx_semantic_components/joint_acceleration_command.hpp>
#include <xxx_semantic_components/joint_effort_command.hpp>
#include <xxx_semantic_components/wrench_command.hpp>
#include <xxx_semantic_components/wrench_derivative_command.hpp>
#include <xxx_semantic_components/pose_command.hpp>
#include <xxx_semantic_components/twist_command.hpp>
#include <xxx_semantic_components/accel_command.hpp>
...
protected:
  ...
  std::unique_ptr<xxx_semantic_components::JointVelocityCommand> joint_velocity_command_;
  std::unique_ptr<xxx_semantic_components::JointAccelerationCommand> joint_acceleration_command_;
  std::unique_ptr<xxx_semantic_components::JointEffortCommand> joint_effort_command_;
  std::unique_ptr<xxx_semantic_components::WrenchCommand> joint_wrench_command_;

  std::unique_ptr<xxx_semantic_components::PoseCommand> task_space_pose_command_;
  std::unique_ptr<xxx_semantic_components::TwistCommand> task_space_twist_command_;
  std::unique_ptr<xxx_semantic_components::AccelCommand> task_space_acceleration_command_;
  std::unique_ptr<xxx_semantic_components::WrenchCommand> task_space_wrench_command_;
  std::unique_ptr<xxx_semantic_components::WrenchDerivativeCommand> task_space_wrench_derivative_command_;
