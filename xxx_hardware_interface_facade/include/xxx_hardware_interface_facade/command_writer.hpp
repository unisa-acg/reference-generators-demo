...
public:
   ...
   *
   * This function writes the fields of the \c xxx_control_msgs::msg::JointWrenchPoint to the command interfaces, according to the command interfaces
   ...
   */
  void write_to_command_interfaces(const xxx_control_msgs::msg::JointWrenchPoint& joint_wrench_msg);

  /**
   * @brief Write the task space reference to the command interfaces.
   *
   * This function writes the fields of the \c xxx_control_msgs::msg::TaskSpacePoint to the command interfaces, according to the command interfaces
   * specified via the \c configure_interfaces method. This function is real-time safe.
   *
   * @param[in] task_space_msg The task space message to write.
   */
  void write_to_command_interfaces(const xxx_control_msgs::msg::TaskSpacePoint& task_space_msg);
