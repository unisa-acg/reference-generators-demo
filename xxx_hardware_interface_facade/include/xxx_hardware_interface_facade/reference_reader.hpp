...
public:
   ...
   */
  void read_from_reference_interfaces(xxx_control_msgs::msg::JointWrenchPoint& joint_wrench_msg) const;
   ...
   */
  void read_from_reference_interfaces(xxx_control_msgs::msg::TaskSpacePoint& task_space_msg) const;
