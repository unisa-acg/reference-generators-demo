...
void CommandWriter::write_to_command_interfaces(const xxx_control_msgs::msg::JointWrenchPoint& joint_wrench_msg)
{
  if (!is_configured_())
  {
    return;
...
void CommandWriter::write_to_command_interfaces(const xxx_control_msgs::msg::TaskSpacePoint& task_space_msg)
{
  if (!is_configured_())
  {
    return;
