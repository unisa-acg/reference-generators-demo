                                                   ...
                                                   const CommandInterfaceNamesOverrideConfig& override_config)
{
  ...
  if (has_joint_position_interface_)
  {
    ...
    joint_position_command_ =
        std::make_unique<xxx_semantic_components::JointPositionCommand>(joint_space_controller_name_, num_joints_, joint_position_interface_names_);
  }
  ...
  if (has_joint_velocity_interface_)
  {
    ...
    joint_velocity_command_ =
        std::make_unique<xxx_semantic_components::JointVelocityCommand>(joint_space_controller_name_, num_joints_, joint_velocity_interface_names_);
  }
  ...
  if (has_joint_acceleration_interface_)
  {
    ...
    joint_acceleration_command_ = std::make_unique<xxx_semantic_components::JointAccelerationCommand>(joint_space_controller_name_, num_joints_,
  ...
  if (has_joint_effort_interface_)
  {
    ...
    joint_effort_command_ =
        std::make_unique<xxx_semantic_components::JointEffortCommand>(joint_space_controller_name_, num_joints_, joint_effort_interface_names_);
  }
  ...
  if (has_joint_wrench_interface_)
  {
    ...
    {
      if (override_config.joint_wrench_interface_names.size() != xxx_semantic_components::WrenchCommand::WRENCH_SIZE)
      {
        RCLCPP_ERROR(
            rclcpp::get_logger("command_interface_handler"),
            ...
            override_config.joint_wrench_interface_names.size(), xxx_semantic_components::WrenchCommand::WRENCH_SIZE);
        return false;
      }
      joint_wrench_command_ =
          std::make_unique<xxx_semantic_components::WrenchCommand>(joint_space_controller_name_, override_config.joint_wrench_interface_names);
    }
    else
    {
      joint_wrench_command_ = std::make_unique<xxx_semantic_components::WrenchCommand>(joint_space_controller_name_);
    }
  ...
  if (has_task_space_pose_interface_)
  {
    ...
    {
      if (override_config.task_space_pose_interface_names.size() != xxx_semantic_components::PoseCommand::POSE_SIZE)
      {
        RCLCPP_ERROR(rclcpp::get_logger("command_interface_handler"),
                     ...
                     override_config.task_space_pose_interface_names.size(), xxx_semantic_components::PoseCommand::POSE_SIZE);
        return false;
      }
      task_space_pose_command_ =
          std::make_unique<xxx_semantic_components::PoseCommand>(task_space_controller_name_, override_config.task_space_pose_interface_names);
    }
    else
    {
      task_space_pose_command_ = std::make_unique<xxx_semantic_components::PoseCommand>(task_space_controller_name_);
    }
  ...
  if (has_task_space_twist_interface_)
  {
    ...
    {
      if (override_config.task_space_twist_interface_names.size() != xxx_semantic_components::TwistCommand::TWIST_SIZE)
      {
        RCLCPP_ERROR(rclcpp::get_logger("command_interface_handler"),
                     ...
                     override_config.task_space_twist_interface_names.size(), xxx_semantic_components::TwistCommand::TWIST_SIZE);
        return false;
      }
      task_space_twist_command_ =
          std::make_unique<xxx_semantic_components::TwistCommand>(task_space_controller_name_, override_config.task_space_twist_interface_names);
    }
    else
    {
      task_space_twist_command_ = std::make_unique<xxx_semantic_components::TwistCommand>(task_space_controller_name_);
    }
  ...
  if (has_task_space_acceleration_interface_)
  {
    ...
    {
      if (override_config.task_space_acceleration_interface_names.size() != xxx_semantic_components::AccelCommand::ACCEL_SIZE)
      {
        RCLCPP_ERROR(rclcpp::get_logger("command_interface_handler"),
                     ...
                     override_config.task_space_acceleration_interface_names.size(), xxx_semantic_components::AccelCommand::ACCEL_SIZE);
        return false;
      }
      task_space_acceleration_command_ = std::make_unique<xxx_semantic_components::AccelCommand>(
          task_space_controller_name_, override_config.task_space_acceleration_interface_names);
    }
    else
    {
      task_space_acceleration_command_ = std::make_unique<xxx_semantic_components::AccelCommand>(task_space_controller_name_);
    }
  ...
  if (has_task_space_wrench_interface_)
  {
    ...
    {
      if (override_config.task_space_wrench_interface_names.size() != xxx_semantic_components::WrenchCommand::WRENCH_SIZE)
      {
        RCLCPP_ERROR(rclcpp::get_logger("command_interface_handler"),
                     ...
                     override_config.task_space_wrench_interface_names.size(), xxx_semantic_components::WrenchCommand::WRENCH_SIZE);
        return false;
      }
      task_space_wrench_command_ =
          std::make_unique<xxx_semantic_components::WrenchCommand>(task_space_controller_name_, override_config.task_space_wrench_interface_names);
    }
    else
    {
      task_space_wrench_command_ = std::make_unique<xxx_semantic_components::WrenchCommand>(task_space_controller_name_);
    }
  ...
  if (has_task_space_wrench_derivative_interface_)
  {
    ...
    {
      if (override_config.task_space_wrench_derivative_interface_names.size() != xxx_semantic_components::WrenchDerivativeCommand::WRENCH_SIZE)
      {
        RCLCPP_ERROR(rclcpp::get_logger("command_interface_handler"),
                     "The number of names in the override configuration (%ld) for the task space wrench "
                     ...
                     xxx_semantic_components::WrenchDerivativeCommand::WRENCH_SIZE);
        return false;
      }
      task_space_wrench_derivative_command_ = std::make_unique<xxx_semantic_components::WrenchDerivativeCommand>(
          task_space_controller_name_, override_config.task_space_wrench_derivative_interface_names);
    }
    else
    {
      task_space_wrench_derivative_command_ = std::make_unique<xxx_semantic_components::WrenchDerivativeCommand>(task_space_controller_name_);
    }
