...
void ReferenceReader::read_from_reference_interfaces(xxx_control_msgs::msg::JointWrenchPoint& joint_wrench_msg) const
{
  if (!is_configured_())
  {
    return;
...
void ReferenceReader::read_from_reference_interfaces(xxx_control_msgs::msg::TaskSpacePoint& task_space_msg) const
{
  if (!is_configured_())
  {
    return;
