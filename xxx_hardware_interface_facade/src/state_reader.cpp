                                             ...
                                             const std::string& robot_name, const StateInterfaceNamesOverrideConfig& override_config)
{
  ...
  if (has_joint_position_state_interface_)
  {
    ...
    position_encoder_ = std::make_unique<xxx_semantic_components::PositionEncoder>(robot_name_, num_joints_, position_interfaces_names_);
  }
  ...
  if (has_joint_velocity_state_interface_)
  {
    ...
    velocity_encoder_ = std::make_unique<xxx_semantic_components::VelocityEncoder>(robot_name_, num_joints_, velocity_interfaces_names_);
  }
  ...
  if (has_joint_acceleration_state_interface_)
  {
    ...
    accelerometer_ = std::make_unique<xxx_semantic_components::Accelerometer>(robot_name_, num_joints_, acceleration_interfaces_names_);
  }
  ...
  if (has_joint_effort_state_interface_)
  {
    ...
    effort_sensor_ = std::make_unique<xxx_semantic_components::EffortSensor>(robot_name_, num_joints_, effort_interfaces_names_);
  }
